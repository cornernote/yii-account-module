...
$I->wantTo('ensure AccountUserController reset password works');
...
$I->amOnPage('/account/user/resetPassword/user_id/1/token/test-invalid-token');
$I->see('Invalid token.');

// reset password with empty details
$I->amOnPage('/account/user/resetPassword/user_id/1/token/test-token');
