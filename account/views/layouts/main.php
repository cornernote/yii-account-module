...
foreach (array_keys($this->module->controllerMap) as $controllerName) {
    $items[] = array(
        'label' => Yii::t('account', ucfirst($controllerName)),
        'url' => Yii::app()->getUser()->getState('index.account' . ucfirst($controllerName), array($controllerName . '/index')),
