 ...
 */
class AccountActiveRecord extends CActiveRecord
{
    /**
    ...
    public function createTable()
    {
        ...
        $file = Yii::getPathOfAlias('account.migrations') . '/' . $this->tableName() . '.' . $db->getDriverName();
    ...
    public function tableName()
    {
        /** @var AccountModule $account */
        $account = Yii::app()->getModule('account');
        if (!empty($account->modelMap[get_class($this)]['tableName']))
            return $account->modelMap[get_class($this)]['tableName'];
